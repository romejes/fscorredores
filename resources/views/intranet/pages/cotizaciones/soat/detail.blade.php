    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item">
            <a href="{{ URL::to('intranet/cotizaciones/soat') }}">Cotización SOAT</a>
          </li>
        ...
        <div class="card card-primary card-outline">
          <div class="card-header">
            ...
            <div class="float-sm-right">
              <a class="btn btn-primary" href="{{ url('intranet/cotizaciones/soat') }}"><i
          ...
          <div class="card-body" id="detail-cotizacion-soat">
            ...
            <dl class="row">
              ...
              <dd class="col-sm-8">
                {{ $detalleCotizacion->TieneSoat == 0 ? 'No': 'Si' }}
              </dd>
            </dl>

            @if($detalleCotizacion->TieneSoat == true)
            <dl class="row">
              <dt class="col-sm-4">Fecha de vencimiento del SOAT</dt>
              <dd class="col-sm-8">
                {{ $detalleCotizacion->FechaVencimiento }}
              </dd>
            </dl>
            @endif
          </div>
