...
<main id="seguros-main">
  ...
  <section class="section">
    <div class="container">
      <div class="row">
        <div class="col">
          <h4 class="section-title color-fs-blue">Cotizar SOAT</h4>
        </div>
      </div>
      <div class="row">
        <div class="wizard">
          <ul class="nav">
            ...
            <li>
              <a class="nav-link" href="#tab-pane-datos-vehiculo"
                >Paso 2 <br /><small>Datos del vehículo</small></a
              >
            </li>
            <li>
              <a class="nav-link" href="#tab-pane-datos-cotizacion"
                >Paso 3 <br /><small>Datos de la cotización</small></a
              >
            </li>
          </ul>
          ...
          <form autocomplete="off">
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-pane-datos-cotizacion">
                ...
                <div class="form-group col-12">
                  <label
                    >¿Cuenta usted con un SOAT en este momento, o no?</label
                  >
                  <div class="form-check">
                    <input type="radio" name="tiene-soat" id="rad-tengo-soat" />
                    <label for="rad-tengo-soat">Si</label>
                  </div>
                  <div class="form-check">
                    <input
                      type="radio"
                      name="tiene-soat"
                      id="rad-no-tengo-soat"
                    />
                    <label for="rad-no-tengo-soat">No</label>
                  </div>
                </div>

                <div class="form-group col-12">
                  <label for="txt-fecha-vencimiento"
                    >Ingrese la fecha de vencimiento de su SOAT actual</label
                  >
                  <input
                    type="text"
                    name="fecha-vencimiento"
                    id="txt-fecha-vencimiento"
                    class="form-control"
