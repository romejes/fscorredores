...
if (Object(_shared_util__WEBPACK_IMPORTED_MODULE_1__["existsElement"])('#frm-contacto')) {
  ...
  document.getElementById('btn-enviar').addEventListener('click', function () {
    if (Object(_functions_validation__WEBPACK_IMPORTED_MODULE_2__["isValid"])('#frm-contacto')) {
...
if (Object(_shared_util__WEBPACK_IMPORTED_MODULE_0__["existsElement"])('#ddo-seguros')) {
  document.getElementById('ddo-seguros').addEventListener('change', function (event) {
...
if (Object(_shared_util__WEBPACK_IMPORTED_MODULE_0__["existsElement"])('.wizard')) {
  ...
  window.onresize = function () {
    Object(_functions_wizard__WEBPACK_IMPORTED_MODULE_3__["resizeTabContainer"])(document.querySelector(".tab-pane[style*='display: block']"));
  };
}
...
if (Object(_shared_util__WEBPACK_IMPORTED_MODULE_0__["existsElement"])('#btn-menu')) {
  //  Toggles sidenav bar
  ...
  window.addEventListener('load', function () {
    return Object(_functions_menu__WEBPACK_IMPORTED_MODULE_1__["attachMenuContent"])();
  });
...
/*!***************************************************!*\
  !*** ./resources/assets/js/web/functions/menu.js ***!
  \***************************************************/
/*! exports provided: toggleSidenav, attachMenuContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function showSidenav() {
  ...
  $('.wrapper .overlay').addClass('active'); //  When sidenav is shown, replaces icon on button menu
...
function hideSidenav() {
  ...
  $('.wrapper .overlay').removeClass('active'); //  When sidenav is hidden, replaces icon on button menu
...
function setErrorPlacement(error, element) {
  var controlTag = element.prop('tagName').toLowerCase(); //  Add class for message

  error.addClass('invalid-feedback'); //  Set validation message according tag and type (if is an input element)
...
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validation */ "./resources/assets/js/web/functions/validation.js");
...
function validStep(stepIndex) {
  ...
  controls.each(function (index, control) {
    if (!Object(_validation__WEBPACK_IMPORTED_MODULE_1__["isValid"])(control)) {
      invalidControls++;
    }
  });
...
function resizeTabContainer(tabPane) {
  var heightTabPane = $(tabPane).height();
  $('.tab-content').eq(0).height(heightTabPane);
}
/**
...
/***/ 0:
/*!***********************************************************************************!*\
  !*** multi ./resources/assets/js/web/app.js ./resources/assets/sass/web/app.scss ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/jesus/Projects/fscorredores/resources/assets/js/web/app.js */"./resources/assets/js/web/app.js");
