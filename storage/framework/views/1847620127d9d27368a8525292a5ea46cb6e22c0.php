    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item">
            <a href="<?php echo e(URL::to('intranet/cotizaciones/soat')); ?>">Cotización SOAT</a>
          </li>
        ...
        <div class="card card-primary card-outline">
          <div class="card-header">
            ...
            <div class="float-sm-right">
              <a class="btn btn-primary" href="<?php echo e(url('intranet/cotizaciones/soat')); ?>"><i
                  class="fas fa-arrow-left"></i> Ver Listado</a>
            </div>
          </div>
          <div class="card-body" id="detail-cotizacion-soat">
            ...
            <dl class="row">
              <dt class="col-sm-4">Tiene SOAT vigente</dt>
              <dd class="col-sm-8">
                <?php echo e($detalleCotizacion->TieneSoat == 0 ? 'No': 'Si'); ?>

              </dd>
            </dl>

            <?php if($detalleCotizacion->TieneSoat == true): ?>
            <dl class="row">
              <dt class="col-sm-4">Fecha de vencimiento del SOAT</dt>
              <dd class="col-sm-8">
                <?php echo e($detalleCotizacion->FechaVencimiento); ?>
