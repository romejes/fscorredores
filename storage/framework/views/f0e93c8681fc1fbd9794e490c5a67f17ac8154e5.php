  ...
  <div class="sidebar">
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview  <?php echo e(Request::segment(2) == 'compras' ? 'menu-open' : ''); ?>">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo e(URL::to('intranet/compras/soat')); ?>"
                class="nav-link <?php echo e(Request::segment(3) == 'soat' && Request::segment(2) == 'compras' ? 'active': ''); ?>">
