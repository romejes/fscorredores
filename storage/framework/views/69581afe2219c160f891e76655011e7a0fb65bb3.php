    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-4 main_footer_section" id="container_company_logo_footer">
          <img src="<?php echo e(asset('img/logo2.svg')); ?>" alt="FS Corredores de Seguros" id="company_logo_footer">
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4 main_footer_section" id="container_supervised_by">
          ...
          <img id="sbs_logo" src="<?php echo e(asset('img/sbs.svg')); ?>" alt="Superintendencia de Banca y Seguros" />
        </div>
      </div>
    </div>
  </div>
