<footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-4 main_footer_section" id="container_company_logo_footer">
          <img src="<?php echo e(asset('images/logo2.svg')); ?>" alt="FS Corredores de Seguros" id="company_logo_footer">
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4 main_footer_section" id="container_supervised_by">
          ...
          <img id="sbs_logo" src="<?php echo e(asset('images/sbs.svg')); ?>" alt="Superintendencia de Banca y Seguros" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="wrapper_copyright">
    <div class="container">
      <div class="row">
        <div class="col">
          <p>FS Corredores de Seguros &copy; <?php echo e(date('Y')); ?>. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  </div>
